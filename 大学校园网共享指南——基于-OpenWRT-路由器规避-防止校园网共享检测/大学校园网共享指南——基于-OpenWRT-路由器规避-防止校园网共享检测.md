...
这套数据应该不是最新的，2022年寒假校园网又进行了一次大扩容，具体扩容了多少不得而知。如果按照这套数据计算，总出口 47GB，活跃用户数2.43万，则人均带宽是（47GB \* 1000 \* 8）/ 24300 = 15 Mbps。这点可怜的带宽，还要给学校的官网防 DDoS，加上网安等种种因素，就变成了一人一终端这种限制。
