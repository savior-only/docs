...
![图片](assets/1711471298-f2c4186a39daad68781aac2a024778c5.webp)       kubeletctl 是一个用于与kubelet API 交互的命令行工具，可以通过kubeletctl执行命令获取Node权限。从Node节点窃取高权限服务账户token，使用服务账户向API Server进行验证，从而获取集群权限。
...
![图片](assets/1711471298-db8521827e0c5b3f659567bac8945efd.webp)进入容器弹出一个shell，在另一个虚拟机上开一个监听，成功进行容器逃逸
...
192.168.17.131为node1地址![图片](assets/1711471298-20ceb1e5d0e76ba4b057fee8e6ee6938.webp)

> 参考：
> 
> -   云原生kubernetes安全 https://blog.csdn.net/qq\_34101364/article/details/122506768
>     
